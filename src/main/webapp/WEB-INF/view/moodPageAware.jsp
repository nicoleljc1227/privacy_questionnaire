...
<div id="container" class="container">
    ...
    <form name="myform" action="${basePath}mood_question_aware" class="form" method="post" onsubmit="return checkform(this)">
            ...
            <li>
                <div class="noLabelAlign">
                    <div class="content section-desc">
                        <p>
                            假设以下文字是您准备在您使用的社交应用发布的，请根据自身情况判断以下内容可以共享给哪些人?谢谢！
